 ...
 *
 */
public class AlexSalesSolutionTunedLater {

	public static void main(String[] customerBillInput) {

		StringBuilder sbf = new StringBuilder();
		sbf.append("[");
		Arrays.stream(customerBillInput).forEach(x ->  sbf.append(" ").append(x).append(" "));
		sbf.append("]");
		System.out.println("Alex can serve:::customers:::" +
				sbf.toString()+":::"
				+ salesDecision(customerBillInput));
	}
	...
	private static Boolean salesDecision(String[] customerBillInput) {
		...
		/**
		 * billList.add(5); billList.add(5); billList.add(10);
		 * 
		 * billList.add(20); billList.add(50); billList.add(10); billList.add(20);
		 * billList.add(10); billList.add(5); billList.add(10);
		 */
